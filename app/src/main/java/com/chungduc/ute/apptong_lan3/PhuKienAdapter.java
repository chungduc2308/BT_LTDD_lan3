...
public class PhuKienAdapter extends BaseAdapter {
    ...
    public PhuKienAdapter(Context context_409, String[] title_409, int[] image_row_409) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        view =layoutInflater_409.inflate(R.layout.phukien_row, null);
        TextView textView_409 = view.findViewById(R.id.txv_noidung);
        ImageView imageView_409 =view.findViewById(R.id.img_phukien);
